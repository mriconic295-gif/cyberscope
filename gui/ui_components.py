...
def apply_shadow(widget):
    ...
    shadow.setBlurRadius(15)  # Reduced for low-spec PC performance
...
class GlowButton(QPushButton):
    ...
    def __init__(self, text, parent=None):
        ...
        self.animation.setStartValue(46)
...
class StatusCard(GlassCard):
    ...
    def online(self):
        ...
        self.value.setStyleSheet("color:#00D26A; font-size:20px; font-weight:bold;")

    def offline(self):
        self.value.setText("OFFLINE")
        self.value.setStyleSheet("color:#FF4C4C; font-size:20px; font-weight:bold;")
...
class InfoCard(GlassCard):
    ...
    def __init__(self, title, text="", parent=None):
        ...
        self.info.setStyleSheet("color:#B8C7E0; font-size:12px; background:transparent;")
...
class CircularRiskMeter(QWidget):
    ...
    def paintEvent(self, event):
        ...
        # Background Circle
        pen = QPen(QColor("#233044"), 12)
        painter.setPen(pen)
        painter.drawEllipse(rect)

        # Progress Color Setup
        if self._value < 35:
            color = QColor("#00D26A")
        elif self._value < 70:
            color = QColor("#FFB020")
        ...
        angle = int(360 * self._value / self._maximum)
...
class ScanStatusCard(GlassCard):
    ...
    def __init__(self, parent=None):
        super().__init__("Scan Status", parent)
        self.status = AnimatedLabel("Waiting...")
        self.status.setStyleSheet("color:#00BFFF; font-size:15px; font-weight:bold; background:transparent;")
        self.progress = ScanProgress()

        self.layout.addWidget(self.status)
        self.layout.addWidget(self.progress)

    def updateStatus(self, text, value):
...
class LoadingOverlay(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        self.setStyleSheet("QFrame { background: rgba(8,15,30,210); border-radius: 12px; }")
        ...
        self.title.setStyleSheet("color:white; font-size:18px; font-weight:bold; background:transparent;")
        ...
        self.status.setStyleSheet("color:#B8C7E0; background:transparent; font-size:13px;")
...
class TerminalCard(GlassCard):
    ...
    def __init__(self, parent=None):
        super().__init__("Terminal Output", parent)
        self.output = QLabel()
    ...
    def append(self, text):
        ...
        self.output.setText(current + text + "\n")
...
class ScreenshotCard(GlassCard):
    ...
    def __init__(self, parent=None):
        super().__init__("Website Screenshot", parent)
...
class AISummaryCard(GlassCard):
    ...
    def __init__(self, parent=None):
        super().__init__("AI Security Summary", parent)
        self.summary = QLabel()
        self.summary.setWordWrap(True)
        self.summary.setAlignment(Qt.AlignTop)
        self.summary.setStyleSheet("background:transparent; color:#E2E8F0; font-size:12px;")
...
class DashboardHeader(QWidget):
    ...
    def __init__(self, title="CyberScope", parent=None):
        super().__init__(parent)
        layout = QHBoxLayout(self)
        layout.setContentsMargins(0, 0, 0, 0)

        self.title = QLabel(title)
        self.title.setStyleSheet("color:white; font-size:26px; font-weight:bold; background:transparent;")

        self.subtitle = QLabel("Professional Website Intelligence Platform")
...
class StatusIndicator(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.dot.setStyleSheet("background:#00D26A; border-radius:6px;")
...
class NeonSeparator(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        self.setStyleSheet("background:#00BFFF; border:none;")
...
class DashboardFooter(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        label = QLabel("CyberScope 2.0  •  by Krunal Paliwal")
        label.setStyleSheet("color:#64748B; font-size:11px; background:transparent;")
